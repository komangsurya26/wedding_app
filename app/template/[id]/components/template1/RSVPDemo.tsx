...
const commentsDummy: RSVPRecord[] = [
    {
        id: 1,
        invitation_id: 1,
        name: "Budi",
        attendance: "yes",
        guest_count: 1,
        message: "Selamat ya, semoga langgeng terus",
        created_at: "2023-01-01T00:00:00.000Z",
    },
];

export function RSVPDemo({ invitationId }: { invitationId: number }) {
